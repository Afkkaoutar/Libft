...
SRCS = ft_isalpha.c ft_memcpy.c ft_strlen.c ft_tolower.c ft_split.c \
	ft_isascii.c ft_memmove.c ft_strchr.c ft_strmapi.c ft_toupper.c \
	ft_isdigit.c ft_memset.c ft_strdup.c ft_strncmp.c ft_atoi.c \
	ft_isprint.c ft_putchar_fd.c ft_striteri.c ft_strnstr.c \
	ft_bzero.c ft_putendl_fd.c ft_strjoin.c ft_strrchr.c ft_itoa.c \
